<template>
  <div class="grid-container">
    <div class="grid-item" v-for="job in jobs">
      <b>
        {{ job.title }}
      </b>
      <button @click="() => showDetail(job)">View Detail</button>
    </div>
  </div>
  <br />
  <br />
  <div class="card" v-if="detail">
    ...
    <div class="card-body">
      <p class="job-description" v-html="detail.description.txt"></p>
      <ul class="job-requirements">
        <li v-for="skill in detail.ptJobSkills">
          {{ skill.name }}
        </li>
      </ul>
      <form class="application-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="email" v-model="phone" required />
        </div>
        <div class="form-group">
          <label for="message">Write your message here:</label>
          <input type="text" id="email" v-model="message" required />
        </div>
        <div class="form-group">
        ...
        <button class="apply-btn" @click="handleSubmit">Submit Application</button>
      </form>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async handleSubmit() {
      const data = {
        ...
        ptJobPost: { id: this.detail.id }
      }

      try {
        const response = await axios.post('https://bti.id/services/btiportalcorems/api/pt-job-applies/no-auth', data)
